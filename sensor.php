...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
		<div class="col-md-10">
				<h1>เซ็นเซอร์และโมดูล(Sensor and Modul)</h1>
                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img class="slide-image" src="image/sm1.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="image/sm2.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="image/sm3.jpg" alt="">
                                </div>
                            </div>
			...
			mysql_select_db("acsm_17670caadcc3c49");
				$strSQL = mysql_query("select * from products where Type=6 order by PID desc ")or die(mysql_error());
