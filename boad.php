		...
		<div class="col-md-10">
                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img class="slide-image" src="image/e.png" alt="">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="image/avr.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="image/ras.jpg" alt="">
                                </div>
                            </div>
            ...
            <div class="col-md-2">
               ...
               mysql_connect("us-cdbr-azure-west-c.cloudapp.net","b287023b504590","03d275fa");
				...
				$strSQL = mysql_query("select * from products where Type=3 order by PID desc ")or die(mysql_error());
