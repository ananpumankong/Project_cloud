...
$strSQL = "SELECT * FROM orders_detail";
...
<body>
  ...
  <li role="presentation"class="active"><a href="admin3.php">จำนวนการสั่งซื้อ</a></li>
...
<h2>ระบบตรวจสอบจำนวสินค้าที่สั่งซื้อ</h2>
...
<div class="panel panel-default">
  ...
  <div class="panel-heading">ตารางตรวจสอบจำนวการสั่งซื้อ</div>
  ...
  ?>
  <tr>
	<th><?php echo $objResult["DetailID"];?></th>
    <th><?php echo $objResult["OrderID"];?></th>
    <th><?php echo $objResult["ProductID"];?></th>
    <th><?php echo $objResult["Qty"];?>ชิ้น</th>
