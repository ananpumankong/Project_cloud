...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
		<div class="col-md-10">
				<h1>เซอร์โวมอเตอร์(Servo Motor)</h1>
                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img class="slide-image" src="image/s.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="image/s2.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="image/s3.jpg" alt="">
                                </div>
                            </div>
			...
			mysql_select_db("acsm_17670caadcc3c49");
				$strSQL = mysql_query("select * from products where Type=1 order by PID desc ")or die(mysql_error());
