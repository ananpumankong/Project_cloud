        ...
        <div class="row">
            ...
            <div class="col-md-9">
               ...
               mysql_connect("us-cdbr-azure-west-c.cloudapp.net","b287023b504590","03d275fa");
				...
				$strSQL = mysql_query("select * from products order by PID desc limit 6")or die(mysql_error());
                while($objResult = mysql_fetch_array($strSQL)){
                    ?>
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <img src="showpic.php?id=<?php echo $objResult['PID']; ?>"style="width: 400px; height: 200px;">
                            <div class="caption">
