...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
		<div class="col-md-10">
				<h1>อุปกรณ์เครื่อง 3D(3D Printer)</h1>
                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img class="slide-image" src="image/3d3.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="image/3d2.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="image/3d1.jpg" alt="">
                                </div>
                            </div>
            ...
            <div class="col-md-2">
	           ...
	           mysql_select_db("acsm_17670caadcc3c49");
				$strSQL = mysql_query("select * from products where Type=4 order by PID desc ")or die(mysql_error());
