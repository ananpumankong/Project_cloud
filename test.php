...
$strSQL = "SELECT * FROM giswebdatabase";
...
<body>
  ...
  <li role="presentation"class="active"><a href="test.php">ตรวจสมาชิก<span class="badge">5</span></a></li>
...
<div class="panel panel-default">
  ...
  <div class="panel-heading">ตารางตรวจสอบสมาชิก</div>
  ...
  ?>
  <tr>
	<th><?php echo $objResult["ID"];?></th>
    <th><?php echo $objResult["USER_ID"];?></th>
    <th><?php echo $objResult["PASSWORD"];?></th>
    <th><?php echo $objResult["EMAIL"];?></th>
	<th><?php echo $objResult["BD"];?></th>
	<th><?php echo $objResult["STATUS"];?></th>
	<th><?php echo $objResult["ranking"];?></th>
	<td align="center"><a href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='userdelete.php?ID=<?php echo $objResult["ID"];?>';}">Delete</a></td>
